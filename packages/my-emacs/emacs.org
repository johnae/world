...
*** Tweak modeline
#+BEGIN_SRC elisp
  (setq global-mode-string (string-join (list (jae/shell-command-to-string-nows "whoami") "@" (jae/shell-command-to-string-nows "hostname") " ") ""))
#+END_SRC
** Utility functions
...
*** Leader key bindings
  #+BEGIN_SRC elisp
    (jae/leader-keys
      ...
      "pp" '(consult-projectile :which-key "open file in project")
      "ps" '(projectile-switch-project :which-key "switch project")
      "pb" '(consult-buffer :which-key "switch buffer")
