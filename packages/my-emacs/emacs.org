...
*** Leader key bindings
  #+BEGIN_SRC elisp
    (jae/leader-keys
      ...
      "pb" '(persp-switch-to-buffer :which-key "switch perspective buffer")
      "pe" '(persp-switch :which-key "switch perspective/new perspective")
...
*** Set default theme
   #+BEGIN_SRC elisp
     (defvar jae:theme 'modus-vivendi)
