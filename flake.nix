{
  ...
  inputs = {
    ...
    fluxcd-install.url = "https://github.com/fluxcd/flux2/releases/download/v2.0.0-rc.3/install.yaml"; # gh-release-update
    ...
    nushell.flake = false;
    nushell.url = "github:nushell/nushell/0.80.0"; # gh-release-update
