{
  ...
  inputs = {
    ...
    fluxcd-install.url = "https://github.com/fluxcd/flux2/releases/download/v2.1.1/install.yaml"; # gh-release-update
    ...
    nushell.flake = false;
    nushell.url = "github:nushell/nushell/0.85.0"; # gh-release-update
