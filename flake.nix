{
  ...
  inputs = {
    ...
    fluxcd-install.url = "https://github.com/fluxcd/flux2/releases/download/v2.0.1/install.yaml"; # gh-release-update
    ...
    nushell.flake = false;
    nushell.url = "github:nushell/nushell/0.83.1"; # gh-release-update
