{
  ...
  inputs = {
    ...
    fluxcd-install.url = "https://github.com/fluxcd/flux2/releases/download/v0.39.0/install.yaml"; # gh-release-update
    ...
    nushell.flake = false;
    nushell.url = "github:nushell/nushell/0.75.0"; # gh-release-update
    ...
    persway.url = "github:johnae/persway/master-stack-v2";
    ristate.flake = false;
