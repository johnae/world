...
in
{
  ...
  systemd.user.services = {
    persway = swayservice "Small Sway IPC Deamon" "${pkgs.persway}/bin/persway -w -a -e '[tiling] opacity 1; border pixel 0' -f '[tiling] opacity 0.93; opacity 1; border pixel 3'";
